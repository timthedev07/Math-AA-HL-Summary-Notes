...
Treat all other variables as a function of the variable with respect to which the entire expression is differentiated. In the end, isolate $\diff{y}{x}$\lb
E.g. differentiate the following

$$x^2 + y^2 = 4$$
\begin{align*}
  2x + 2y\diff{y}{x} & = \diff{}{x}4  \\
  x + y\diff{y}{x}   & = 0            \\
  \diff{y}{x}        & = -\frac{x}{y} \\
\end{align*}
